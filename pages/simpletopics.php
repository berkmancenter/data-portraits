...
/**
 *
 * Data-Portraits/pages/topics.php
 * Page for calling Topic Modelling Controller
 *
...
require_once(ROOT_PATH."/controller/class.SimpleTopicModellingController.php");

$controller = new SimpleTopicModellingController();
echo $controller->go();